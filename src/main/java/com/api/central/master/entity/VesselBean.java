...
public class VesselBean implements Serializable {
	...
	public String toString() {
		return "VesselBean [vesselID=" + vesselID + ", imoNumber=" + imoNumber + ", vesselName=" + vesselName
				+ ", officialNumber=" + officialNumber + ", vesselPK=" + vesselPK + ", vesselUK=" + vesselUK
				+ ", callSign=" + callSign + ", grossTon=" + grossTon + ", vesselType=" + vesselType
				...
				+ ", regOwnedImoNo=" + regOwnedImoNo + ", keelLaidDate=" + keelLaidDate + "]";
	}

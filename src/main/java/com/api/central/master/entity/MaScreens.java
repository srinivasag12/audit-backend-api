...
* $ History – File Name MaScreens.java $
******************  Version 1.0.0 *****************
* & Author – Tharani priya   DateTime – Created Date Thu Mar 30 2017 15:23:44 GMT+0530 (India Standard Time) $
* $ Created in -  File Name with Package Structure /CentralAuditApi/src/main/java/com/api/central/master/entity/MaScreens.java $
**/
...
@Entity
@Table(name = "MA_SCREENS")
@IdClass(MaScreensCpk.class)
@JsonInclude(value = Include.NON_NULL)
public class MaScreens implements Serializable {

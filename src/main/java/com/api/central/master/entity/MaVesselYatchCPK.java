...
* $ Created in -  File Name with Package Structure CentralAuditApi\src\main\java\com\api\central\master\entity\MaVesselYatchCPK.java $
**/
...
public class MaVesselYatchCPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MaVesselYatchCPK other = (MaVesselYatchCPK) obj;
	if (companyId == null) {

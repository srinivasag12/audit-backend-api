...
* $ Created in -  File Name with Package Structure /CentralAuditApi/src/main/java/com/api/central/master/entity/MaAuditTypeCpk.java $
**/
...
public class MaAuditTypeCpk implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MaAuditTypeCpk other = (MaAuditTypeCpk) obj;
		if (auditTypeId == null) {

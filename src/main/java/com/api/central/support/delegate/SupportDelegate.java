...
public interface SupportDelegate {
	...
	SupportDetail getDownloadFile(Integer auditSeqNo, Integer vesselImoNo, Integer auditTypeId, Integer auditSubTypeId, Long companyId);

	Map<String, String> getLeadName(Integer auditSeqNo, Long companyId);

	List<SupportDetail> getSupportAuditDtls(SearchCriteria auditDtls);
